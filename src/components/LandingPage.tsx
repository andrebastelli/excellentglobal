  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main role="main" id="top">
          ...
          <div className="relative mx-auto max-w-7xl px-5 py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <CTA event="click_whatsapp_hero">
                  <Sparkles className="h-5 w-5" /> Quero minha aula demonstrativa grátis
                </CTA>
                <CTA event="click_whatsapp_hero_secondary" variant="secondary">
                  <MessageCircle className="h-5 w-5" /> Falar no WhatsApp
                </CTA>
              </div>
              <p className="mt-3 text-sm text-white/75">
                Atendimento rápido pelo WhatsApp. Vagas demonstrativas limitadas para Limeira/SP.
              </p>
            </div>
        ...
        <section className="py-20 md:py-28 bg-secondary/40">
          <div className="mx-auto max-w-6xl px-5">
            ...
            <div className="mt-14 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { i: Mic, t: "Aulas 100% conversação", d: "Você aprende praticando o inglês em situações reais, ganhando confiança para falar." },
                { i: RotateCw, t: "Metodologia não-linear", d: "Os conteúdos são revisados de forma constante e estratégica para melhorar a retenção." },
                { i: Award, t: "Mais de 25 anos de experiência", d: "Uma escola consolidada em Limeira, com trajetória, autoridade e milhares de alunos atendidos." },
                { i: GraduationCap, t: "Certificado", d: "Ao concluir sua formação, você recebe certificado para valorizar sua jornada." },
                { i: Users, t: "Aulas em grupo ou individuais", d: "Escolha o formato que mais combina com sua rotina, objetivo e nível de aprendizado." },
                { i: Building2, t: "Ambiente moderno e acolhedor", d: "Salas confortáveis, estrutura física de qualidade e espaço preparado para aprender." },
              ].map(({ i: Icon, t, d }) => (
                <div key={t} className="bg-card rounded-2xl p-7 shadow-soft border border-border/60 hover:border-primary/30 hover:-translate-y-1 transition">
        ...
        <section className="py-20 md:py-28 bg-gradient-hero text-white relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-5xl px-5 text-center">
            ...
            <div className="mt-12 grid md:grid-cols-3 gap-5 text-left">
              {[
                { n: "1", t: "Clique no WhatsApp", d: "Fale com a equipe e informe seu interesse no curso de inglês." },
                { n: "2", t: "Escolha um horário disponível", d: "A escola ajuda você a encontrar o melhor horário para sua aula demonstrativa." },
                { n: "3", t: "Conheça a metodologia na prática", d: "Participe de uma experiência real e tire suas dúvidas com a equipe." },
              ].map((s) => (
            ...
            <div className="mt-12">
              <CTA event="click_whatsapp_aula_demo">
          ...
          <div className="mx-auto max-w-6xl px-5">
            ...
            <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                ...
                <div key={p.t} className="rounded-2xl p-6 bg-card border border-border shadow-soft hover:border-primary hover:-translate-y-1 transition">
        ...
        {/* SEÇÃO 9 — DEPOIMENTOS */}
        {/* TODO: Substituir pelos depoimentos reais dos alunos da Excellent Global */}
        <section className="py-20 md:py-28 bg-secondary/40">
          <div className="mx-auto max-w-6xl px-5">
            ...
            <div className="mt-12 grid md:grid-cols-3 gap-6">
              {[
                { n: "Nome do aluno", d: "Depoimento sobre a experiência com as aulas de inglês, evolução na conversação e atendimento da escola." },
                { n: "Nome do aluno", d: "Depoimento sobre como a metodologia ajudou a ganhar confiança para falar inglês." },
                { n: "Nome do aluno", d: "Depoimento sobre estrutura, professores e evolução no aprendizado." },
              ].map((t, i) => (
        ...
        <section className="py-20 md:py-28">
          <div className="mx-auto max-w-6xl px-5">
            ...
            {/* TODO: substituir pelas fotos reais do espaço físico */}
        ...
        <section className="py-20 md:py-28 bg-secondary/40">
          <div className="mx-auto max-w-3xl px-5">
            ...
            <div className="mt-12 space-y-3">
              {[
                ["A aula demonstrativa é realmente gratuita?", "Sim. A aula demonstrativa é gratuita e serve para você conhecer a metodologia da Excellent Global antes de iniciar."],
                ["O curso é para iniciantes?", "Sim. A metodologia permite que alunos iniciantes também comecem a desenvolver o inglês de forma progressiva."],
                ["As aulas são presenciais em Limeira?", "Sim. O atendimento e as aulas são presenciais em Limeira/SP."],
                ["Tenho vergonha de falar inglês. Esse curso é para mim?", "Sim. As aulas são conduzidas para ajudar o aluno a ganhar confiança aos poucos, com prática e acompanhamento."],
                ["A escola oferece certificado?", "Sim. A Excellent Global oferece certificado ao aluno."],
                ["Posso fazer aula em grupo ou individual?", "Sim. A escola oferece opções em grupo ou individuais, de acordo com disponibilidade e objetivo."],
                ["Como faço para agendar a aula demonstrativa?", "Basta clicar no botão de WhatsApp e falar com a equipe da Excellent Global."],
              ].map(([q, a]) => (
                <details
                  key={q}
        ...
        <section className="py-20 md:py-28 bg-gradient-hero text-white text-center relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-3xl px-5">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-3">
              <CTA event="click_whatsapp_final">
                <Sparkles className="h-5 w-5" /> Quero minha aula demonstrativa grátis
              </CTA>
        ...
        <div className="mx-auto max-w-6xl px-5 grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/85">
              <li className="flex items-center gap-2"><MapPin className="h-4 w-4" /> Limeira / SP</li>
              <li className="flex items-center gap-2"><Phone className="h-4 w-4" /> WhatsApp para agendamento</li>
            </ul>
          </div>
          <div>
            <h3 className="font-bold mb-3">Ação rápida</h3>
            <CTA event="click_whatsapp_footer" variant="whatsapp" className="!py-3">
              <MessageCircle className="h-4 w-4" /> Agendar aula grátis
            </CTA>
          </div>
        </div>
